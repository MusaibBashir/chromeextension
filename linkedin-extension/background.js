/**
 * LinkedIn Jobs Scraper - Background Service Worker
 */
...
function updateBadge(count, color = '#0A66C2') {
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.action === 'JOBS_SCRAPED') {
        ...
        chrome.storage.local.set({
            lastScrapedJobs: message.jobs,
            lastScrapedUrl: message.url,
...
console.log('LinkedIn Jobs background service started');
