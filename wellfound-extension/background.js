/**
 * Wellfound Jobs Scraper - Background Service Worker
 */
...
async function getSettings() {
    ...
    return { apiUrl: result.apiUrl || DEFAULT_API_URL, apiKey: result.apiKey || null };
}
...
console.log('Wellfound Jobs background service started');
